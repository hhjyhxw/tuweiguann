...
public class CouponApiController {
    ...
    @ResponseBody
    public R shopcouponList(String pageNum,String pageSize,@RequestParam Long shopId,@LoginUser WxUser user) {
        //传入id为空则读取平台商品
        if(shopId==null){
...
//    }
    ...
    @ResponseBody
    public R mycouponList( @RequestParam String status,String pageNum, String pageSize, @RequestParam Long shopId, @LoginUser WxUser user) {
...
//        List<MycouponVo> newlist = new ArrayList<>();
    ...
    @ResponseBody
    public R getCoupon( @RequestParam Long couponId, @RequestParam Long shopId, @LoginUser WxUser user) {
        ...
        userCoupon.setShopId(smallCoupon.getShopId());
